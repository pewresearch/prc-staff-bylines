<?php
/**
 * @package PRC\TDS\Tests
 */

namespace PRC\TDS\Tests\Unit;

use Closure;
use WP_UnitTestCase;

use function PRC\TDS\get_save_post_hook;
use function PRC\TDS\get_save_term_hook;
use function PRC\TDS\get_delete_post_hook;
use function PRC\TDS\get_delete_term_hook;
use function PRC\TDS\get_post_link_hook;
use function PRC\TDS\get_post_type_link_hook;
...
class Test_HookGetters extends WP_UnitTestCase {
	...
	public function test_returns_closure( string $function ) {
		$callable = ( '\\PRC\\TDS\\' . $function )( 'tds-pt', 'tds-tax' );
